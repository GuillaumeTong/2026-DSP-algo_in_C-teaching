...
La bibliothèque d'entrée-sortie:
 \href{https://cedric.cnam.fr/~lamberta/enseignements/DSP/C/sources/inout.h}{inout.h} et   \href{https://cedric.cnam.fr/~lamberta/enseignements/DSP/C/sources/inout.c}{inout.c} mettez les dans un répertoire \texttt{tp2}. Pour cela vous pouvez
...
\item \lstinline!void ecritPlusSommeProd(int z, int t)! écrit à
  ...
  arguments.
\end{enumerate}
%\begin{correction}   \lstinputlisting{../corriges/tp2_exo1.c}  \end{correction}
\end{exo}
...
%\begin{correction}  \lstinputlisting{../corriges/tp2_exo2.c}  \end{correction}
\end{exo}
...
\end{enumerate}
%\begin{correction}  \lstinputlisting{../corriges/tp2_exo3.c}  \end{correction}
\end{exo}
...
\end{enumerate}
%\begin{correction}  \lstinputlisting{../corriges/tp2_exo4.c}  \end{correction}
\end{exo}
